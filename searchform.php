...
<form method="get" class="search-form" id="<?php echo esc_attr( $form_unique_id ); ?>" action="<?php echo esc_url( home_url( '/' ) ); ?>">
	<input type="search" class="search-field" placeholder="<?php _e( 'Search Form', 'hitchcock' ); ?>" name="<?php echo esc_attr( $field_unique_id ); ?>" id="<?php echo esc_attr( $field_unique_id ); ?>" /> 
